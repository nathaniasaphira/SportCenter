...
public class UserRepository(DatabaseConnection databaseConnection) : IRepository<User>
{
    ...
    public User GetById(int id)
    {
        ...
        return connection.QuerySingleOrDefault<User>(query, new { Id = id }) ?? throw new Exception("User not found");
    }
